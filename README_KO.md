...
나는 원래 일을 많이 받아오는데 잘 깜빡하는 편이라, 해야 할 일을 놓쳐서 혼난 적도 많았습니다. 예전에는 나만의 Excel 스케줄러를 만들어 썼지만 PC 앞에서만 기록할 수 있고 손이 너무 많이 가서, 결국 나 말고는 아무도 안 썼습니다.

그래서 오래전부터 **폰에서도 이어지고, 내가 일일이 적지 않아도 알아서 일정과 할 일을 잡아주는 ‘나만의 스케줄러’**를 만들고 싶었습니다. 코딩이 장벽이었지만 AI가 그 장벽을 낮춰주면서 직접 프로그램을 만들 수 있게 됐고, **가장 먼저 만든 프로그램이 바로 AI Work Scheduler였습니다.**

지금은 이 ‘꿈의 스케줄러’를 더 확장해서, AI 명령창에서 다른 업무 프로그램의 일정과 상태를 불러오고 설명받은 뒤 다시 내 일정과 연결할 수 있는 개인 업무 허브로 키우고 있습니다.
